...
def get_logger(
    ...
    Args:
        service_name: Name of the service (e.g., "inoah-brain", "inoah-dating")
    ...
    Example:
        logger = get_logger("inoah-dating")
        logger.info("Server started on port 8010")
        # Output: [14:32:01] [inoah-dating] INFO: Server started on port 8010
    """
